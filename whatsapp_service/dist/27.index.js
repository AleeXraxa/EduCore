...
const { isLinux, getReport } = __webpack_require__(98407);
const { LDD_PATH, SELF_PATH, readFile, readFileSync } = __webpack_require__(54387);
const { interpreterPath } = __webpack_require__(83235);
...
const parseOptions = __webpack_require__(67392)
const { safeRe: re, t } = __webpack_require__(10459)
const cmp = __webpack_require__(10474)
const debug = __webpack_require__(77475)
const SemVer = __webpack_require__(87743)
const Range = __webpack_require__(10098)
...
const LRU = __webpack_require__(68787)
const cache = new LRU()

const parseOptions = __webpack_require__(67392)
const Comparator = __webpack_require__(10391)
const debug = __webpack_require__(77475)
const SemVer = __webpack_require__(87743)
const {
  safeRe: re,
  ...
  tildeTrimReplace,
  caretTrimReplace,
} = __webpack_require__(10459)
const { FLAG_INCLUDE_PRERELEASE, FLAG_LOOSE } = __webpack_require__(35745)
...
const debug = __webpack_require__(77475)
const { MAX_LENGTH, MAX_SAFE_INTEGER } = __webpack_require__(35745)
const { safeRe: re, t } = __webpack_require__(10459)

const parseOptions = __webpack_require__(67392)
const { compareIdentifiers } = __webpack_require__(28656)
class SemVer {
...
const eq = __webpack_require__(16822)
const neq = __webpack_require__(43818)
const gt = __webpack_require__(23867)
const gte = __webpack_require__(69576)
const lt = __webpack_require__(34580)
const lte = __webpack_require__(51505)
...
const SemVer = __webpack_require__(87743)
const parse = __webpack_require__(26325)
const { safeRe: re, t } = __webpack_require__(10459)
...
const compare = __webpack_require__(22649)
...
const is = __webpack_require__(72207);
...
const color = __webpack_require__(44779);
const is = __webpack_require__(72207);
...
const stream = __webpack_require__(79456);
const is = __webpack_require__(72207);
...
const Sharp = __webpack_require__(26059);
__webpack_require__(53459)(Sharp);
__webpack_require__(83295)(Sharp);
__webpack_require__(90304)(Sharp);
__webpack_require__(22490)(Sharp);
__webpack_require__(85043)(Sharp);
__webpack_require__(82736)(Sharp);
__webpack_require__(1630)(Sharp);
__webpack_require__(15351)(Sharp);
...
const is = __webpack_require__(72207);
const sharp = __webpack_require__(3547);
...
const semverCoerce = __webpack_require__(16341);
const semverGreaterThanOrEqualTo = __webpack_require__(69576);
const semverSatisfies = __webpack_require__(77199);
const detectLibc = __webpack_require__(12640);
...
const buildSharpLibvipsIncludeDir = () => {
  try {
    ...
    try {
      return __webpack_require__(89103);
    } catch {}
  }
  return '';
};
...
const buildSharpLibvipsCPlusPlusDir = () => {
  ...
  try {
    return __webpack_require__(90660);
  } catch {}
  return '';
};
...
const { familySync, versionSync } = __webpack_require__(12640);

const { runtimePlatformArch, isUnsupportedNodeRuntime, prebuiltPlatforms, minimumLibvipsVersion } = __webpack_require__(91192);
...
const is = __webpack_require__(72207);
const { runtimePlatformArch } = __webpack_require__(91192);
const sharp = __webpack_require__(3547);
...
if (!libvipsVersion.isGlobal) {
  if (!libvipsVersion.isWasm) {
    ...
    try {
      versions = __webpack_require__(29628);
    } catch (_) {}
  }
}
...
module.exports = __webpack_require__(13958)["default"];
